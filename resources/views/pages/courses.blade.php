...
@section('content')
 ...
 <section class="general_main for_bg_color" style="background-image: url('/images/header-bg.jpg');">
  ...
  <section class="course_in">
    <div class="container">
      <h2 style="text-transform: uppercase;">эффективные видео-уроки</h2>
      <div class="tab_main">
        <ul class="nav nav-tabs" id="myTab">
          <li class="active"><a data-target="#all" data-toggle="tab" class="active show">Курсы</a></li>
          <li><a data-target="#online" data-toggle="tab">Видео-уроки</a></li>
        </ul>
          ...
          <div role="tabpanel" class="tab-pane in active" id="all">
            ...
            <div class="video_item">
              ...
              <div class="video_item_text">
                ...
                <a href="{{route('get-course',$course->slug)}}" class="btn_template">Начать изучение</a>
              </div>
            </div>
            @endforeach
            <div class="video_item">
              <a href="video_inside_all.html" class="video_item_img not_number">
                <img src="/images/chess-board.svg" alt="">
              </a>
              <div class="video_item_text">
                <div class="video_item_text_racet"><img src="/images/raceta.svg" alt="">Видео-урок</div>
                ...
                <a href="courses_in.html" class="btn_template">Начать изучение</a>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="video_item_unit">
                  ...
                  <div class="video_item_unit_text">
                    <h5>Как ходят фигуры? Как ходят фигуры?</h5>
                    <div class="video_item_unit_text_about">
                      <div class="video_item_unit_text_price">
                        <img src="images/money.svg" alt="">
                        45 тыс. сум
